...
nohup curl --compressed -v -uprashant@urbanzeak.com "https://stream.gnip.com:443/accounts/Urbanzeak/publishers/twitter/streams/track/prod.json" -uprashant@urbanzeak.com:KHELDAR@123 > gnip_output10.json &
