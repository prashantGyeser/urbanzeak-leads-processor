...
ActiveRecord::Schema.define(version: 20140919140808) do
  ...
  create_table "dashboard_twitter_searches", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "keyword"
    t.string   "city"
  ...
  create_table "datasift_subscriptions", force: true do |t|
